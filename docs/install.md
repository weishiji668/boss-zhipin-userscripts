...
| 脚本 | 安装 | 装它的理由 |
| --- | --- | --- |
| 页面过滤 | [boss-filter.user.js](https://raw.githubusercontent.com/OWNER/REPO/main/boss-filter.user.js) | 先把噪音挡掉，后面所有脚本都受益 |
| 命中打标签 | [boss-tag.user.js](https://raw.githubusercontent.com/OWNER/REPO/main/boss-tag.user.js) | 只标记不隐藏，适合先观察 |
| 岗位监控 | [boss-watcher.user.js](https://raw.githubusercontent.com/OWNER/REPO/main/boss-watcher.user.js) | 盯住心仪岗位的变化 |
| 聊天助手 | [boss-chat.user.js](https://raw.githubusercontent.com/OWNER/REPO/main/boss-chat.user.js) | 会话归档 + 复盘导出 |
| 会话体检 | [boss-insight.user.js](https://raw.githubusercontent.com/OWNER/REPO/main/boss-insight.user.js) | 风险词扫描 + 一键处置 |
| 一致性体检 | [boss-consist.user.js](https://raw.githubusercontent.com/OWNER/REPO/main/boss-consist.user.js) | 卡片与正文矛盾 |
...
```
https://raw.githubusercontent.com/OWNER/REPO/main/boss-filter.user.js   ← 默认
https://cdn.jsdelivr.net/gh/OWNER/REPO@main/boss-filter.user.js      ← jsDelivr 镜像（国内通常更快）
