...
// @updateURL    https://raw.githubusercontent.com/weishiji668/jiajianchengchu-boss/main/boss-chat.user.js
// @downloadURL  https://raw.githubusercontent.com/weishiji668/jiajianchengchu-boss/main/boss-chat.user.js
...
function renderAll(){
  ...
  html+='<details class="bc-fold"><summary>收录说明 / AI 判定边界</summary><div class="bc-foldbody"><div class="bc-muted" style="font-size:11px">「收录」＝把会话与消息存进本机档案（只读，不发消息、不点站内按钮）。用例：本脚本收录<b>会话与消息</b>，岗位监控脚本收录的是<b>岗位</b>。<br>「一键收录全部」会<b>回放页面自己的只读请求</b>逐个拉取历史消息（每个间隔 1-3 秒，遇风控立即停）；没点开过的会话拿不到令牌会跳过（点开一次即可收录）。<br>'+
